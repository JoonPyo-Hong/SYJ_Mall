/* 
	...
	Description : 추천 신규 테마 비로그인 상태(더보기 기능) - 대분류 필터는 없는 상태 또한 소분류 필터도 없는 상태
	     
	History	:	2021-11-23 Seunghwan Shin	#최초 생성
				2021-11-26 Seunghwan Shin	#페이징 숫자 다르게 지정
				2021-12-26 Seunghwan Shin	#인덱싱 테이블 수정
	
	Real DB : exec dbo.kakao_recommend_new_theme_no_login_add_no_big_category_no_small_category '119#118#9', '1', '0',

*/
alter proc dbo.kakao_recommend_new_theme_no_login_add_no_big_category_no_small_category
