...
*/
alter proc dbo.kakao_recommend_new_theme_login_add_big_category_small_category
	@qoouser_seq_no bigint			-- 쿠키정보
,	@theme_num int					-- 대분류 카테고리 옵션
,	@prodt_catgr int				-- 소분류 카테고리 옵션
...
begin
				...
				begin
					...
					(
						...
						and kpc.category_code = @prodt_catgr
